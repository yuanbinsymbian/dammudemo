...
const MYSQL_HOST = process.env.MYSQL_HOST || "115.190.196.175";
...
async function processWorldRankings(accessToken,appId) {
    ...
    await uploadRankList(accessToken, appId, worldRankVersion, isOnlineVersion, top150);
...
async function setWorldRankVersion(accessToken, appId, worldRankVersion, isOnlineVersion) {
  try {
    ...
    const headers = { 'content-type': 'application/json', 'x-token': String(accessToken) };
    const payload = { app_id: String(appId), world_rank_version: String(worldRankVersion), is_online_version: Boolean(isOnlineVersion) };
...
async function completeUploadUserResult(accessToken, appId, worldRankVersion, isOnlineVersion, completeTime) {
  try {
    ...
    const headers = { 'content-type': 'application/json', 'x-token': String(accessToken) };
    const payload = { app_id: String(appId), world_rank_version: String(worldRankVersion), is_online_version: Boolean(isOnlineVersion), complete_time: Number(completeTime) };
...
async function uploadRankList(accessToken, appId, worldRankVersion, isOnlineVersion, rankList) {
  try {
    ...
    const headers = { 'content-type': 'application/json', 'x-token': String(accessToken) };
    const payload = { app_id: String(appId), world_rank_version: String(worldRankVersion), is_online_version: Boolean(isOnlineVersion), rank_list: rankList };
...
async function uploadUserResult(accessToken, appId, worldRankVersion, isOnlineVersion, userList) {
  try {
    ...
    const headers = { 'content-type': 'application/json', 'x-token': String(accessToken) };
    const payload = { app_id: String(appId), world_rank_version: String(worldRankVersion), is_online_version: Boolean(isOnlineVersion), user_list: userList };
